        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="contacts__info">
                    ...
                    <div class="contacts__mail">
                        ...
                        <a href="mailto:<?php the_field('mail', 2); ?>" class="header__contacts-mail"><?php the_field('mail', 2); ?>
                        </a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="contacts__feed">
                    <?php echo do_shortcode('[contact-form-7 id="3eda9ea" title="Форма отзывов"]')?>
                </div>
            </div>
        </div>
        <div class="row mt70">
                        ...
                        <ul class="glide__slides">
                            <?php 
                                $my_posts = get_posts( array(
                                    ...
                                    'category_name'    => 'feedback', //название категории
                                    'orderby'     => 'date',
